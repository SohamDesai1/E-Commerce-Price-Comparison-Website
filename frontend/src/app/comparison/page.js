        ...
        <>
            <section className="text-white bg-gray-900 body-font">
                <div className="container px-5 py-24 mx-auto">
                    ...
                    <Link href="#section">
                        <button className="flex px-8 py-2 mx-auto mt-16 text-lg text-white bg-indigo-500 border-0 rounded focus:outline-none hover:bg-indigo-600" >Compare</button></Link>
                </div>
            </section>
                ...
                <form className='bg-white rounded-md shadow-lg' onSubmit={handleSubmit}>
                    <div className="flex items-center justify-center p-2">
                        <input type="text" placeholder="Search Product"
                            className="w-full px-2 py-1 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-600 focus:border-transparent" onChange={(e) => setInputData(e.target.value)} />
                        <button type="submit"
                            className="px-4 py-1 ml-2 text-white bg-gray-800 rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-opacity-50">
                            Search
                        </button>
                    </div>
                </form>
